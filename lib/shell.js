...
module.exports = function(config) {
    ...
    app.prototype.runTask = function(data) {
        ...
        var rtn = shell.exec('sudo forever start ' + __root + '/tasks/' + data.data + '.js ' + data.params + data.monitor);
    ...
    app.prototype.stopTask = function(data) {
        ...
        var rtn = shell.exec('sudo forever stop ' + __root + '/tasks/' + data.data + '.js');
